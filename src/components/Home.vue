  ...
  <div class="container mt-5 text-center">
    <div class="shadow p-5">
      ...
      <p>
        ...
        your address, and displays information about them. We have a collection
        of over 1000 unique sites with photos, geographical and historical
    ...
    <Map :sites="sites" class="mt-5"> </Map>
  </div>
</template>

<script>
import axios from "axios";
import { API_KEY, SERVER } from "../commons.js";
...
export default {
  ...
  methods: {
    ...
    loadSites() {
      ...
      axios
        .get(`${SERVER}/sites?longitude=${longitude}&latitude=${latitude}`)
        .then((res) => {
          this.sites = res.data;
          this.loaded = true;
        });
